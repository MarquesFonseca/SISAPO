    ...
    public partial class FormularioAlteracaoTiposPostaisMassa : Form
    {
        ...
        private void BtnGravar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dataInicial_dateTimePickerAnoMesDiaFormatado = DataInicial_dateTimePicker.Value.Date.ToShortDateString();
                        ...
                        foreach (DataRow itemObjetoNaoEntregue in DsObjetosNaoEntreguesMesmoTipoSigla.Tables[0].Rows)
                        {
                            ...
                            if (AoRemetente) // ao remetente
                            {
                                if (ClienteCaixaPostal)
                                {
                                    ...
                                    if (radioButtonAPartirDoDia.Checked)
                                        dao.ExecutaSQL("UPDATE TabelaObjetosSROLocal SET TipoPostalPrazoDiasCorridosRegulamentado = @PrazoRemetenteCaixaPostal WHERE (CodigoObjeto = @CodigoObjeto) AND (DateValue(DataLancamento) >= DateValue(@DataLancamento))", pr1);
                                    else
                                ...
                                else // não é caixa postal
                                {
                                    ...
                                    if (radioButtonAPartirDoDia.Checked)
                                        dao.ExecutaSQL("UPDATE TabelaObjetosSROLocal SET TipoPostalPrazoDiasCorridosRegulamentado = @PrazoRemetenteCaidaPedida WHERE (CodigoObjeto = @CodigoObjeto) AND (DateValue(DataLancamento) >= DateValue(@DataLancamento))", pr2);
                                    else
                            ...
                            else // ao destinatário
                            {
                                ...
                                else // nao é caixa postal
                                {
                                    ...
                                    if (radioButtonAPartirDoDia.Checked)
                                        dao.ExecutaSQL("UPDATE TabelaObjetosSROLocal SET TipoPostalPrazoDiasCorridosRegulamentado = @PrazoDestinoCaidaPedida WHERE (CodigoObjeto = @CodigoObjeto) AND (DateValue(DataLancamento) >= DateValue(@DataLancamento))", pr4);
                                    else
        ...
        private void PrazoDestinatarioCaidaPedidaUpDown_Enter(object sender, EventArgs e)
        {
            PrazoDestinatarioCaidaPedidaUpDown.Select(0, PrazoDestinatarioCaidaPedidaUpDown.Text.Length);
            PrazoDestinatarioCaidaPedidaUpDown.Focus();
        }
        ...
        private void PrazoDestinatarioCaixaPostalUpDown_Enter(object sender, EventArgs e)
        {
            PrazoDestinatarioCaixaPostalUpDown.Select(0, PrazoDestinatarioCaixaPostalUpDown.Text.Length);
            PrazoDestinatarioCaixaPostalUpDown.Focus();
        }
        ...
        private void PrazoRemetenteCaidaPedidaUpDown_Enter(object sender, EventArgs e)
        {
            PrazoRemetenteCaidaPedidaUpDown.Select(0, PrazoRemetenteCaidaPedidaUpDown.Text.Length);
            PrazoRemetenteCaidaPedidaUpDown.Focus();
        }
        ...
        private void PrazoRemetenteCaixaPostalUpDown_Enter(object sender, EventArgs e)
        {
            PrazoRemetenteCaixaPostalUpDown.Select(0, PrazoRemetenteCaixaPostalUpDown.Text.Length);
            PrazoRemetenteCaixaPostalUpDown.Focus();
        }

        private void PrazoDestinatarioCaidaPedidaUpDown_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void PrazoDestinatarioCaixaPostalUpDown_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                this.SelectNextControl(this.ActiveControl, !e.Shift, true, true, true);
        ...
        private void PrazoRemetenteCaidaPedidaUpDown_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                this.SelectNextControl(this.ActiveControl, !e.Shift, true, true, true);
        ...
        private void PrazoRemetenteCaixaPostalUpDown_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                this.SelectNextControl(this.ActiveControl, !e.Shift, true, true, true);
        ...
        private void comboBoxTipoClassificacao_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                this.SelectNextControl(this.ActiveControl, !e.Shift, true, true, true);
        ...
        private void radioButtonTodos_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                this.SelectNextControl(this.ActiveControl, !e.Shift, true, true, true);
