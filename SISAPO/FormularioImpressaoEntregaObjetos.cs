...
namespace SISAPO
{
    public partial class FormularioImpressaoEntregaObjetos : Form
    {
        ...
        public FormularioImpressaoEntregaObjetos(List<string> _codigosSelecionados)
        {
            InitializeComponent();
        ...
        private StringBuilder RetornaHtml()
        {
            ...
            Html.AppendLine("<title>Lista de entrega de objetos na agência - SISAPO-SRO Sistema de apoio ao rastreamento unificado</title>");
